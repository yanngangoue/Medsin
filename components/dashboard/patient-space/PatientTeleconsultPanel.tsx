    ...
    <div className="flex h-full flex-col">
      <div className="border-b border-slate-100 px-5 py-4 sm:px-6">
        ...
        <p className="mt-1 text-sm leading-relaxed text-slate-600">
          Prenez rendez-vous avec un médecin MedSim, puis rejoignez la salle sécurisée à l&apos;heure
          prévue.
        </p>
      </div>
      ...
      <div className="flex-1 space-y-5 px-5 py-5 sm:px-6">
        ...
        <p className="text-[10px] leading-relaxed text-slate-400">
          Visioconférence chiffrée via salle privée MedSim. Connexion possible 15 min avant le
