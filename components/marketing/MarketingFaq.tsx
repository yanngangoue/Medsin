...
const FAQ = [
  ...
  },
  {
    ...
    a: "Felix est une excellente plateforme, mais elle opère principalement en anglais et n'offre pas de suivi IA proactif. MedSim est 100 % québécois, en français authentique, et Anne vous contacte en premier chaque semaine — vous n'avez pas à demander de l'aide, on vient à vous.",
  },
  {
