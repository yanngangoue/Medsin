...
/** IPS Anne-sante — portraits et spécialités (données vitrine). */
export const IPS_SHOWCASE_PROFILES: readonly IpsShowcaseProfile[] = [
  ...
  },
  {
    ...
    quote:
      "Prescrire, c'est une chose. Suivre les effets, l'adhésion et le moral, c'est tout le parcours Anne-sante.",
