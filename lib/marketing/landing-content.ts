...
export const FAQ_ITEMS = [
  {
    ...
    a: "L'admissibilité dépend de votre IMC, antécédents médicaux et critères cliniques. Complétez l'évaluation gratuite en ligne : un médecin Anne-sante analysera votre dossier sous 24 h.",
  },
  {
  ...
  },
  {
    ...
    a: `Felix n'offre pas de coach IA proactif comme ${COACH_NAME}, qui analyse vos données et vous écrit en premier. Anne-sante combine prescription médicale, tableau de bord visuel et accompagnement ${COACH_NAME} 24 h/24 — au même prix tout inclus, avec une interface moderne pensée pour le Québec.`,
  },
  {
    q: "Comment annuler ?",
