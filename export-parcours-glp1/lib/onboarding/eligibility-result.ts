...
export function evaluateEligibility(draft: EligibilityDraft): EligibilityResult {
  ...
  if (draft.age < 18) {
    return {
      ...
      message: "Le programme MedSim s'adresse aux adultes de 18 ans et plus.",
      ctaHref: "/",
    };
  }
    ...
    return {
      ...
      message:
        lowBmi && borderlineDiabetes
          ? "Votre IMC est sous le seuil habituel et certaines réponses nécessitent une revue clinique. Un professionnel MedSim vous contactera."
          : lowBmi
