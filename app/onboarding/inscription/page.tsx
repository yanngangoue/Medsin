    ...
    <div className="mx-auto w-full max-w-[480px] pb-12 pt-2">
      {phase === "welcome" ? (
        <div className="flex flex-col items-center px-1 text-center">
          ...
          <div className="mt-6 max-w-xs rounded-full border border-[#C8E6D9] bg-white/90 px-4 py-2 text-center text-xs font-medium leading-snug text-[#0D1F1A]/85 shadow-sm shadow-teal-900/[0.04] backdrop-blur-sm">
            Données confidentielles et médicales sécurisées
          </div>
          <button
            type="button"
            onClick={startFields}
