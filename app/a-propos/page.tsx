...
export const metadata = {
  title: "À propos de nous — MedSim",
  description:
    "MedSim : plateforme québécoise de santé métabolique en ligne, encadrée par des professionnels certifiés.",
};
...
export default function AProposPage() {
  return (
    <LegalPageLayout title="À propos de nous">
      <p>
        MedSim est une plateforme québécoise de santé métabolique 100 % en ligne. Nous accompagnons les
